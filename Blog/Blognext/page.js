  ...
  return (
    <article className="hentry">
      ...
      <div className="entry-meta">
        <p><span className="author">Written by <a href="#">Lavi Perchik</a></span> <span className="date">Monday, July 9, 2018</span></p>
      </div>
      ...
      <footer className="entry-footer"><p>Credit: <a href="https://mor10.com/wordpress-the-15-year-revolution/">Mor10.com</a></p></footer>
    </article>
  );
}
